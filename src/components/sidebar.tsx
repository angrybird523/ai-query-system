    ...
    <aside className="w-60 bg-[#F8FAFC] border-r border-[#E2E8F0] flex flex-col shrink-0">
      ...
      <nav className="flex-1 py-4 px-3">
        <div className="space-y-1">
          {/* 智能问数 */}
          <button
            onClick={() => onMenuChange('smart-query')}
            className={cn(
          ...
          <div>
            ...
            <div
              className={cn(
                ...
                systemExpanded ? 'max-h-20 opacity-100' : 'max-h-0 opacity-0'
              )}
            >
              <button
                onClick={() => onMenuChange('app-config')}
                className={cn(
          ...
          <div>
            ...
            <div
              className={cn(
                'overflow-hidden transition-all duration-200',
                feedbackExpanded ? 'max-h-20 opacity-100' : 'max-h-0 opacity-0'
              )}
            >
              <button
                onClick={() => onMenuChange('reply-proof')}
                className={cn(
                  'w-full flex items-center gap-2.5 pl-10 pr-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-150',
                  activeMenu === 'reply-proof'
                    ? 'text-[#2563EB] bg-[#EFF6FF]'
